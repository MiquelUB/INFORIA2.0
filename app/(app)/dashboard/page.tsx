            ...
            <Card className="border-0 shadow-lg">
              <CardHeader className="pb-6">
                <div className="flex items-center justify-center space-x-6">
                  <Button variant="outline" size="icon" className="h-9 w-9" onClick={() => navigateMonth("prev")} aria-label="Mes anterior">
                    <ChevronLeft className="h-4 w-4" />
                  </Button>
                  <h2 className="font-serif text-xl font-medium">{getMonthName(currentMonth)} {currentYear}</h2>
                  <Button variant="outline" size="icon" className="h-9 w-9" onClick={() => navigateMonth("next")} aria-label="Mes siguiente">
